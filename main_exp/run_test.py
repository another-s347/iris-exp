...
parser.add_argument("--dataset", default="mnist", choices=["mnist","kmnist"], help="dataset")
parser.add_argument("--delay_rate", type=float, default=0., help="dalayed rate")
parser.add_argument("--ignore_delay", action="store_false", default=True)
parser.add_argument("--method", type=str, default="ours", choices=["ours","ps"])
